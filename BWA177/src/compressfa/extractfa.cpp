 ...
 * \details first get which uint8_t the required index is in, then use bit wise operation to extract which nucleotide it is. Serve as a transparent layer over the compressed vector and the user
 * 
