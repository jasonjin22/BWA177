 ...
 * \details the original fa file use one char to store one nucletide, which is too wasteful, to save space and make the implementation easy, I use 4 bits to store one nucletide, for every two, store their information in a uint8_t and all the fa file is stored in a vector, which will be maintained in the memory
 * 
